...
import { Eye, EyeOff, Mail, Lock, User, Loader2, Activity, ArrowLeft, Check } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md">
        ...
        >
          ...
          <p className="text-slate-600 dark:text-slate-400">Start your fitness transformation today</p>
        </motion.div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start space-x-2">
                    <Checkbox
                      ...
                      className="mt-1"
                    />
                    <Label htmlFor="subscribeNewsletter" className="text-sm text-slate-600 dark:text-slate-400">
                      Send me fitness tips, workout updates, and special offers
                    </Label>
                  </div>
                </div>
        ...
        >
          <p className="text-xs text-slate-500 dark:text-slate-400">
            By creating an account, you're joining over 50,000 users on their fitness journey
          </p>
        </motion.div>
      </div>
    </div>
